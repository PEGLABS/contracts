...
import "../contracts/TEUR.sol";

contract TEURTest is TEUR {
    ...
    function testTokenInitialValues() public {
        Assert.equal(name(), "TEUR", "token name did not match");
        Assert.equal(symbol(), "TEUR", "token symbol did not match");
